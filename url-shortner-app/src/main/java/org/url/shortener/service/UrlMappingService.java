...
public class UrlMappingService {
    ...
    public UrlMappingDTO createShortUrl(String originalUrl, UrlUser user) {
    ...
    public List<UrlMappingDTO> getUrlsByUser(UrlUser user) {
    ...
    public Map<LocalDate, Long> getTotalClicksByUserAndDate(UrlUser user, LocalDate start, LocalDate end) {
